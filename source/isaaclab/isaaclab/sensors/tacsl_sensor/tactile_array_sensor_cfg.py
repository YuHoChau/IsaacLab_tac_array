...
@configclass
class TactileArraySensorCfg(SensorBaseCfg):
    """Configuration for the tactile array sensor.

    This sensor provides tactile array sensing.
    """

    class_type: type = TactileArraySensor
    ...
    tactile_points_distance: float = MISSING
    """Distance between adjacent tactile points (in meters).

    This parameter directly specifies the spacing between adjacent tactile sensing points on the
    elastomer surface. The tactile point grid is generated by placing points at regular intervals
    determined by this distance parameter.
    """
